...
use App\Services\Media\ModelAwarePathGenerator;
...
return [
     ...
     * ModelAwarePathGenerator lit la constante MEDIA_PATH sur le modèle si définie (ex: images/entity/breeds).
     */
    'path_generator' => ModelAwarePathGenerator::class,
