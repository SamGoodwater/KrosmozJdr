...
return [
    ...
    'items' => [
        ...
        [
            'key' => 'essentiel-pdf',
            'label' => 'L’Essentiel (PDF)',
            'description' => 'Aide-mémoire de table : résumés pour jouer et puces MJ, sans le tome complet.',
            'group' => 'essentiel',
            'group_label' => 'L’Essentiel',
            'icon' => 'fa-file-pdf',
            'mime' => 'application/pdf',
            'generated' => true,
            'audience' => 'essentiel',
            'filename' => 'krosmoz-jdr-essentiel.pdf',
        ],
        [
            'key' => 'essentiel-odt',
            'label' => 'L’Essentiel (OpenDocument)',
            'description' => 'Le même aide-mémoire au format ODT, ouvrable dans LibreOffice ou Word.',
            'group' => 'essentiel',
            'group_label' => 'L’Essentiel',
            'icon' => 'fa-file-lines',
            'mime' => 'application/vnd.oasis.opendocument.text',
            'generated' => true,
            'audience' => 'essentiel',
            'filename' => 'krosmoz-jdr-essentiel.odt',
        ],
        [
            'key' => 'mj-pdf',
