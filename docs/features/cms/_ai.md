...
- **Page « Ressources »** (`ressources-de-jeu`) : enfant du chapitre 5 (`regles-5-ressources-et-equilibrage`). Téléchargements (`download_catalog`, `config/game_downloads.php`). Compilation `rules:compile-downloads` (PDF A4 compact, saut de page par partie).
