...
- **Monstres** : coquille `Monster` + stats/sorts sur `Creature` ; sorts liés en aperçu (`effect_usages_chips`, pas l’arbre) ; PDF multi + `visibleToUser` ; Full affiche sorts/empty states.
