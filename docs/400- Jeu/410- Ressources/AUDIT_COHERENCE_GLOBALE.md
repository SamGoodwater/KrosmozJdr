...
- **Règles** : `docs/400- Jeu/420- Règles/` (2.2.1, 2.2.2, 2.6.1, etc.)
- **Caractéristiques BDD** : `database/seeders/data/characteristic_creature.php`, `characteristic_object.php`, `characteristics.php`
- **Fiches ressources** : `docs/400- Jeu/410- Ressources/` (fiche_perso, Equipements et forgemagie, CaractéristiquesAvecLien avec Dofus)
