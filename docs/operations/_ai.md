...
- Source règles CMS : `private/game/rules/TABLE_DES_MATIERES.md`. Livre PDF/ODT : `php artisan rules:compile-downloads` (A4 compact, saut de page par partie ; sans Sources / 6.1.3–6.1.4). Bouton admin `/admin/content` : file `rules-downloads` + worker ponctuel.
