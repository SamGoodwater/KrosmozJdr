...
La conversion depuis **Sources** ne concerne plus seulement les rencontres. Un **sort**, un **PNJ**, un **objet** unique ou un **consommable** peut aussi recevoir une proposition en **auto**, à relire avant de la rendre jouable. Même geste, même suivi sur la page **IA métier**.

## Septembre 2026 — L’IA propose une rencontre

On peut lancer une conversion depuis la fiche, via la même icône **Sources** que DofusDB. Ça écrit une proposition en **auto**, jamais jouable : un **monstre** avec deux ou trois **sorts**. Les admins voient un estimé de coût sur la page **IA métier**. Les MJ n’ont pas le bouton, pour limiter la facture.
