...
- Catalogue objets / ressources / consommables : filtre Type précoché via `show_in_catalog` (flag registre, `defaultByCatalog`). Les listes `GAMEPLAY_*` restent un repli si le flag est absent du payload.
