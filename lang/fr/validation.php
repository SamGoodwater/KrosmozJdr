...
return [
    ...
    'area_notation' => 'La notation de zone est invalide. Formes attendues : point ; line-1xL (L≥1) ; cross-a-b et circle-a-b (a≤b) ; rect-WxH (W,H≥1) ; shape-ID ou shape-ID-p1-p2 (ID≥1).',
    'attributes' => [
        'address' => 'adresse',
