...
class Container_5b19bdb525 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5b19bdb525 $container)
			{
	...
	public function createServiceContainer(): Container_5b19bdb525
	{
		return $this;
	}
