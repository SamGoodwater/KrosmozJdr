...
class Container_8704ea39c1 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8704ea39c1 $container)
			{
	...
	public function createServiceContainer(): Container_8704ea39c1
	{
		return $this;
	}
