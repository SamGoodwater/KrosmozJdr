...
// source: phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_587a429483 extends _PHPStan_c161e9ff7\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['0131', '0134', '0139', '0141', '0142', '0906']],
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['0335', '0784', '0785', '0787', '0836', '0837', '0838', '0844'],
		],
		...
		'Larastan\Larastan\Methods\RelationForwardsCallsExtension' => [['0822']],
		'Larastan\Larastan\Methods\ModelForwardsCallsExtension' => [['0823']],
		'Larastan\Larastan\Methods\EloquentBuilderForwardsCallsExtension' => [['0824']],
		'Larastan\Larastan\Methods\HigherOrderTapProxyExtension' => [['0825']],
		'Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension' => [['0826']],
		'Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension' => [['0827']],
		'Larastan\Larastan\Methods\ContractsMethodsExtension' => [['0828']],
		'Larastan\Larastan\Methods\FacadesMethodsExtension' => [['0829']],
		'Larastan\Larastan\Methods\ManagersMethodsExtension' => [['0830']],
		'Larastan\Larastan\Methods\AuthsMethodsExtension' => [['0831']],
		...
		'Larastan\Larastan\ReturnTypes\EloquentCollectionMapDynamicReturnTypeExtension' => [['0942']],
		'Larastan\Larastan\Rules\NoAuthFacadeInRequestScopeRule' => [['0943']],
		'Larastan\Larastan\Rules\NoAuthHelperInRequestScopeRule' => [['0944']],
		'Larastan\Larastan\Rules\ConfigCollectionRule' => [['0945']],
		'Illuminate\Filesystem\Filesystem' => [['0946']],
	];
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
	...
	public function createService0132(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			$this->getService('024'),
			[
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/stubs/Memcached.stub',
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/stubs/Redis.stub',
				...
				'phar:///var/www/KrosmozJdr/vendor/phpstan/phpstan/phpstan.phar/stubs/ctype.stub',
			],
			['/var/www/KrosmozJdr']
		);
	}
	...
	public function createService0446(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_587a429483 $container)
			{
	...
	public function createService0822(): Larastan\Larastan\Methods\RelationForwardsCallsExtension
	{
	...
	public function createService0823(): Larastan\Larastan\Methods\ModelForwardsCallsExtension
	{
	...
	public function createService0824(): Larastan\Larastan\Methods\EloquentBuilderForwardsCallsExtension
	{
	...
	public function createService0825(): Larastan\Larastan\Methods\HigherOrderTapProxyExtension
	{
		return new Larastan\Larastan\Methods\HigherOrderTapProxyExtension;
	}


	public function createService0826(): Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension
	{
		return new Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension($this->getService('0934'));
	}


	public function createService0827(): Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension
	{
		return new Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension($this->getService('reflectionProvider'));
	}


	public function createService0828(): Larastan\Larastan\Methods\ContractsMethodsExtension
	{
		return new Larastan\Larastan\Methods\ContractsMethodsExtension($this->getService('reflectionProvider'));
	}


	public function createService0829(): Larastan\Larastan\Methods\FacadesMethodsExtension
	{
		return new Larastan\Larastan\Methods\FacadesMethodsExtension($this->getService('reflectionProvider'));
	}


	public function createService0830(): Larastan\Larastan\Methods\ManagersMethodsExtension
	{
		return new Larastan\Larastan\Methods\ManagersMethodsExtension($this->getService('reflectionProvider'));
	}


	public function createService0831(): Larastan\Larastan\Methods\AuthsMethodsExtension
	{
	...
	{
		return new Larastan\Larastan\Properties\MigrationCache('/var/www/KrosmozJdr/storage/phpstan', false);
	}
	...
	{
		return new Larastan\Larastan\Rules\NoMissingTranslationsRule($this->getService('0920'), $this->getService('0946'), []);
	}
	...
	public function createService0942(): Larastan\Larastan\ReturnTypes\EloquentCollectionMapDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\EloquentCollectionMapDynamicReturnTypeExtension;
	}


	public function createService0943(): Larastan\Larastan\Rules\NoAuthFacadeInRequestScopeRule
	{
		return new Larastan\Larastan\Rules\NoAuthFacadeInRequestScopeRule;
	}


	public function createService0944(): Larastan\Larastan\Rules\NoAuthHelperInRequestScopeRule
	{
		return new Larastan\Larastan\Rules\NoAuthHelperInRequestScopeRule;
	}


	public function createService0945(): Larastan\Larastan\Rules\ConfigCollectionRule
	{
		return new Larastan\Larastan\Rules\ConfigCollectionRule($this->getService('0939'));
	}


	public function createService0946(): Illuminate\Filesystem\Filesystem
	{
	...
	public function createServiceContainer(): Container_587a429483
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				'npm_config_devdir' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/node-gyp',
				'VSCODE_CWD' => '/mnt/c/Users/sambo/AppData/Local/Programs/cursor',
				'LOG_STACK' => 'single',
				'VSCODE_ESM_ENTRYPOINT' => 'vs/workbench/api/node/extensionHostProcess',
				'PUPPETEER_CACHE_DIR' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/puppeteer',
				'HTTPS_PROXY' => 'http://127.0.0.1:46557',
				'PRIVACY_ERASURE_WITHDRAWAL_DAYS' => '7',
				'PROJECT_UPDATE_AUTO_ENABLED' => 'true',
				'REDIS_PORT' => '6379',
				'VITE_APP_VERSION' => '0.1.3.1',
				'no_proxy' => '127.0.0.1,::1,localhost',
				'USER' => 'goodwater',
				'VSCODE_NLS_CONFIG' => '{"userLocale":"fr","osLocale":"fr","resolvedLanguage":"en","defaultMessagesFile":"/home/goodwater/.cursor-server/bin/3dc559280adc5f931ade8e25c7b85393842acf30/out/nls.messages.json","locale":"fr","availableLanguages":{}}',
				'PHP_INI_SCAN_DIR' => '',
				'LOG_LEVEL' => 'debug',
				'DB_CONNECTION' => 'mysql',
				'CARGO_TARGET_DIR' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/cargo-target',
				'CCACHE_DIR' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/ccache',
				'all_proxy' => 'http://127.0.0.1:46557',
				...
				'APP_DEBUG' => 'true',
				'PRIVACY_EXPORT_SYNC' => 'true',
				'MAIL_USERNAME' => 'null',
				'CURSOR_RIPGREP_PATH' => '/home/goodwater/.cursor-server/bin/3dc559280adc5f931ade8e25c7b85393842acf30/node_modules/@vscode/ripgrep/bin/rg',
				'PIP_CACHE_DIR' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/pip',
				'NUGET_PACKAGES' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/nuget',
				'HOMEBREW_CACHE' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/homebrew',
				'APP_URL' => 'http://localhost:8000',
				'DB_PORT' => '3306',
				'MAIL_FROM_ADDRESS' => 'contact@krosmoz-jdr.fr',
				'SHLVL' => '1',
				'SOCKS_PROXY' => 'socks5://127.0.0.1:41759',
				...
				'NO_PROXY' => '127.0.0.1,::1,localhost',
				'VSCODE_IPC_HOOK_CLI' => '/run/user/1000/vscode-ipc-38ff64f8-31d7-43fc-851b-8bd0bd02eaf3.sock',
				'DISCORD_CLIENT_ID' => '1482086728754921703',
				'CURSOR_API_KEY' => 'crsr_1401eb51c5c6e42ec12c2573943e5957516a978732ff58096d5f3eae9bed7c0e',
				'DISCORD_CLIENT_SECRET' => 'TaGlLQsbzbpqU_V3cFo5loL0BXGHkjBq',
				...
				'SESSION_PATH' => '/',
				'NO_COLOR' => '1',
				'CONDA_PKGS_DIRS' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/conda',
				...
				'COMPOSER_HOME' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/composer',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:46557',
				...
				'socks5_proxy' => 'socks5://127.0.0.1:41759',
				'SESSION_DOMAIN' => 'null',
				'AUTH_PASSWORD_INACTIVITY_TIMEOUT' => '3600',
				'PROJECT_UPDATE_CRON' => '0 1 1 * *',
				'CACHE_STORE' => 'file',
				'MAIL_MAILER' => 'log',
				'MAIL_PORT' => '8025',
				'NPM_CONFIG_CACHE' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/npm',
				'PWD' => '/var/www/KrosmozJdr',
				'GRADLE_USER_HOME' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/gradle',
				'FNM_MULTISHELL_PATH' => '/run/user/1000/fnm_multishells/1300498_1778576175309',
				'APP_ENV' => 'local',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:46557',
				'HTTP_PROXY' => 'http://127.0.0.1:46557',
				'LINES' => '50',
				'TURBO_CACHE_DIR' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/turbo',
				'FNM_COREPACK_ENABLED' => 'false',
				'DB_HOST' => '127.0.0.1',
				'QUEUE_CONNECTION' => 'database',
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:46557\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:46557\'; builtin export http_proxy=\'http://127.0.0.1:46557\'; builtin export https_proxy=\'http://127.0.0.1:46557\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:46557\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:46557\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:41759\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:41759\'; builtin export socks_proxy=\'socks5://127.0.0.1:41759\'; builtin export socks5_proxy=\'socks5://127.0.0.1:41759\'; builtin export ALL_PROXY=\'http://127.0.0.1:46557\'; builtin export all_proxy=\'http://127.0.0.1:46557\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				'_ZO_DOCTOR' => '0',
				'WSL2_GUI_APPS_ENABLED' => '1',
				'PNPM_HOME' => '/home/goodwater/.local/share/pnpm',
				'GEM_SPEC_CACHE' => '/tmp/cursor-sandbox-cache/e96da267678ece3fc1cc1c5816220aa5/gem-specs',
