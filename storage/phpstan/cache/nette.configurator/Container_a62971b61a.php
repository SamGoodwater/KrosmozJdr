...
class Container_a62971b61a extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a62971b61a $container)
			{
	...
	public function createServiceContainer(): Container_a62971b61a
	{
		return $this;
	}
