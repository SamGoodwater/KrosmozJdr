...
class Container_a63c4b8d3f extends _PHPStan_2526f5004\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a63c4b8d3f $container)
			{
	...
	public function createServiceContainer(): Container_a63c4b8d3f
	{
		return $this;
	}
