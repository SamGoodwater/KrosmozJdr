...
- **characteristics.php** : 107 entrées. Toutes ont `name`, `short_name`, `helper` renseignés. Les champs `descriptions`, `icon`, `color` sont souvent NULL (à compléter via l’admin ou l’export si besoin).
