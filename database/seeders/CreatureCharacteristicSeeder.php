...
class CreatureCharacteristicSeeder extends CharacteristicGroupSeeder
{
    ...
    {
        return 'database/seeders/data/characteristic_creature_norms.php';
    }
     ...
     */
    protected function loadCreatureSamples(): array
    {
        $path = storage_path('app/characteristics_creature_samples.json');
        if (! is_file($path)) {
            return [];
        }
    ...
    public function run(): void
    {
        ...
        $samplesByKey = $this->loadCreatureSamples();
