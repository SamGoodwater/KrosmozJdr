...
class CreatureFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'res_sagesse' => (string) fake()->numberBetween(0, 50),
            'res_vitalite' => (string) fake()->numberBetween(0, 50),
            'do_sagesse' => (string) fake()->numberBetween(0, 100),
            'do_vitalite' => (string) fake()->numberBetween(0, 100),
