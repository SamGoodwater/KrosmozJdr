...
Route::prefix('entities/consumables')->name('entities.consumables.')->middleware('auth')->group(function () {
    ...
    Route::patch('/{consumable}/resources', [ConsumableController::class, 'updateResources'])->name('updateResources');
    Route::post('/{consumable}/recalculate-price', [ConsumableController::class, 'recalculatePrice'])->name('recalculatePrice');
