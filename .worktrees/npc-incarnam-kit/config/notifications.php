...
return [
    ...
    */
    'types' => [
        ...
        'project_maintenance' => [
            'label' => 'Résultat maintenance projet (init/update/backup)',
            'channels_default' => ['database'],
            'frequency_default' => 'instant',
            'frequency_editable' => false,
            'category' => 'admin',
        ...
        'feedback_new_thread' => [
            'label' => 'Nouveau retour utilisateur',
            'channels_default' => ['database'],
            'frequency_default' => 'instant',
            'frequency_editable' => false,
            'category' => 'admin_action',
        ...
        'feedback_user_reply' => [
            'label' => 'Réponse utilisateur à un retour',
            'channels_default' => ['database'],
            'frequency_default' => 'instant',
            'frequency_editable' => false,
            'category' => 'admin_action',
        ...
        'feedback_staff_reply' => [
            'label' => 'Réponse staff à mes retours',
            'channels_default' => ['database'],
            'frequency_default' => 'instant',
            'frequency_editable' => false,
            'category' => 'personal',
            'action_label' => 'Voir mon retour',
        ],
    ],
