        ...
        'sections' => [
            [
                ...
                'html' => '<h2>Capacités</h2>'
                    .'<p>Une capacité est un <strong>avantage passif ou contextuel</strong> : elle tourne toute seule (ou se déclenche), en général sans dépenser de '.$pa.'. Une aptitude / un sort, toi tu les lances. À chaque palier de spé on choisit souvent aptitude <em>ou</em> capacité. '.$k['kCapaLivre'].'.</p>'
            ...
            [
                ...
                'html' => '<h3>Puissance</h3>'
                    ...
                    .'<li><code>is_passive</code> — vrai pour les passifs de classe et la plupart des dons.</li>'
