...
## Rôle et description
Les NPC servent à enrichir l’univers, proposer des quêtes, vendre des objets, interagir avec les joueurs, etc. Ils peuvent avoir une histoire, une classe, une spécialisation, et être liés à des hotels de vente.
...
- **hotel de vente** : un NPC peut être lié à une hotel de vente (`npc_id` dans `shops`).
