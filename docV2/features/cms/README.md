...
- `docs/20-Content/21-Entities/ENTITY_PAGES.md`, `ENTITY_SECTIONS.md`.
- `docs/50-Fonctionnalités/CMS/` (si présent) et pipeline d'import des règles (`app/Support/Cms/Rules*`).
