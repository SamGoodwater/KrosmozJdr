...
- `docs/10-BestPractices/PERMISSIONS_SOURCE_OF_TRUTH.md` — source de vérité des droits.
- `docs/10-BestPractices/ENTITY_VISIBILITY_PHASE_A.md` — matrice de visibilité.
