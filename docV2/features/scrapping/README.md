...
- `docs/50-Fonctionnalités/Scrapping/PIPELINE_ET_MAPPING.md` — flux complet et points de modification.
- `docs/50-Fonctionnalités/Scrapping/Architecture/` — architecture config-driven.
- `docs/50-Fonctionnalités/Scrapping/EFFECTS_SYSTEM.md` — système d'effets (normalisation + bonus).
- `docs/50-Fonctionnalités/Scrapping/MAPPING_DOFUSDB_TO_KROSMOZJDR.md` — mapping champ par champ.
