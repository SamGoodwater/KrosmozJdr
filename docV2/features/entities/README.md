...
Référence exhaustive des champs par entité : `docs/20-Content/21-Entities/` (un fichier `ENTITY_*.md` par type).
...
- `docs/20-Content/21-Entities/ENTITIES_OVERVIEW.md` — modèle de données détaillé, champs par entité, pivots.
- `docs/30-UI/ENTITY_VIEWS.md` — système de vues.
