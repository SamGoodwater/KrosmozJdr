...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'characteristics_rarity.rarity_default_by_level' => 'array',
...
'cache.prefix','characteristics_rarity.rarity_default_by_level','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','purifier.encoding','purifier.finalize',
...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::LIc80hyF4kS0LFU1','scrapping.test.api','scrapping.test.class',
...
'api.entities.consumables.bulk','generated::bVT7wM73w7A4fNBr','register','generated::hb1ojEqxaHgovNJp','login',
'generated::hRpvsaDmbI6rtkBn','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm','generated::byagZfwHoEjMuQSw',
...
'media.thumbnail','media.clean-thumbnails','admin.characteristics.index','admin.characteristics.formula-preview','admin.characteristics.upload-icon',
'admin.characteristics.show','admin.characteristics.update','admin.dofus-conversion-formulas.handlers','admin.dofus-conversion-formulas.formula-preview','admin.spell-effect-types.index',
