...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::0i2kTUMFcylTXtPv','scrapping.test.api','scrapping.test.class',
...
'api.entities.npcs.bulk','api.entities.breeds.bulk','api.entities.consumables.bulk','generated::QBLIyCInL52mTV3P','register',
'generated::GSP3DLiL1FCkfUc9','login','generated::CwEnt9tMETgTo9ZP','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','generated::kuUlOyVvJ0z6nB6Z','logout','user.show','user.edit',
