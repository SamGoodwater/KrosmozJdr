...
'scrapping.test.clear-cache','scrapping.import.class','scrapping.import.monster','scrapping.import.item','scrapping.import.spell',
'scrapping.import.batch','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'logout','user.show','user.edit','user.update','user.updateAvatar',
...
'media.clean-thumbnails','home','contribute','pages.index','pages.show',
