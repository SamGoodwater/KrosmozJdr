...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::bDRAl5pccmIQHTQt','scrapping.test.api','scrapping.test.class',
...
'api.entities.breeds.bulk','api.entities.consumables.bulk','generated::rM5M90Lsaqrwig9R','register','generated::4mVmakHnjLrEPs4f',
'login','generated::MbXLPWYw29B6RpWb','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::dgPZUOGVu7G5UkWq','logout','user.show','user.edit','user.update',
...
'admin.characteristics.update','admin.characteristics.destroy','admin.dofus-conversion-formulas.handlers','admin.dofus-conversion-formulas.formula-preview','admin.spell-effect-types.index',
