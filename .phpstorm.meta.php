...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::UrXKpEJUkDQlLQsS','register','generated::0X4jDW3wHkmOvnMX',
'login','generated::xNG4gn1MFsleOyla','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::1qaNPB0LaEjpzzqy','logout','user.show','user.edit','user.update',
