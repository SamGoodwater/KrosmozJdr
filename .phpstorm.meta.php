...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::a6Fq8B5nxDpxHC4P','scrapping.test.api','scrapping.test.class',
...
'scrapping.import.item','scrapping.import.spell','scrapping.import.batch','scrapping.import.range','scrapping.import.all',
'generated::bLhEQHA4mKZ55hy1','register','generated::dJwMOKXh5qS0AkQM','login','generated::0Y33gjegfvgrAbNs',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','password.confirm','generated::eYOf7mpCqv27LFvs','logout',
'user.show','user.edit','user.update','user.updateAvatar','user.deleteAvatar',
...
'home','contribute','pages.index','pages.show','pages.edit',
'pages.update','pages.create','pages.store','pages.delete','pages.restore',
'pages.forceDelete','sections.show','sections.edit','sections.update','sections.create',
'sections.store','sections.delete','sections.restore','sections.forceDelete','sections.files.store',
'sections.files.delete','scrapping.index','storage.local',);
