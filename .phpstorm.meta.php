...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::ws8rocrNCkB9YHEP','register','generated::YCTVH8LBeEZ8rsHF',
'login','generated::Iy0S8jXcDNVzxB4v','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::pa4yfTYygWOESnJc','logout','user.show','user.edit','user.update',
