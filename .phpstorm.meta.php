...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\sambo\OneDrive\Projets\Jdr Dofus\KrosmozSite\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\sambo\\OneDrive\\Projets\\Jdr Dofus\\KrosmozSite\\public\\storage','logging.default',
...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::96YbDGEtyFtgkuvi','user.dashboard','user.edit',
'user.update','user.updateAvatar','user.deleteAvatar','user.delete','user.create',
'user.store','user.admin.edit','user.admin.update','user.admin.updateAvatar','user.admin.deleteAvatar',
'user.restore','user.admin.updateRole','user.admin.updatePassword','user.forcedDelete','home',
'contribute','storage.local',);
...
'APP_NAME','APP_VERSION','APP_STABILITY','APP_FICHE_VERSION','APP_FICHE_URL',
'APP_SLOGAN','APP_DESCRIPTION','APP_KEYWORDS','APP_ENV','APP_KEY',
'APP_DEBUG','APP_TIMEZONE','APP_URL','APP_LOCALE','APP_FALLBACK_LOCALE',
'APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','X_FRAME_OPTIONS',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_APP_VERSION',
'VITE_APP_STABILITY','VITE_APP_FICHE_VERSION','VITE_APP_FICHE_URL','VITE_APP_DESCRIPTION','VITE_APP_SLOGAN',
'VITE_APP_KEYWORDS',);
