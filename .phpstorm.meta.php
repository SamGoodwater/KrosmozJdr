...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::rrNv6cvDYWUB6lqR','scrapping.test.api','scrapping.test.class',
...
'api.entities.breeds.bulk','api.entities.consumables.bulk','generated::eXoBar15HqTQyNFu','register','generated::BRje64o1krB3WHEv',
'login','generated::FkWO3PmsTgCIQhhL','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::bSFP91OVVf5qCOfM','logout','user.show','user.edit','user.update',
