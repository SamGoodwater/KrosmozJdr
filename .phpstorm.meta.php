...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Goodwater\OneDrive\Projets\Jdr Dofus\KrosmozSite\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Goodwater\\OneDrive\\Projets\\Jdr Dofus\\KrosmozSite\\public\\storage','logging.default',
...
'debugbar.queries.explain','sanctum.csrf-cookie','generated::pddLMZa69IeqWWlF','register','generated::LueXu48Q1zor6jJV',
'login','generated::zapF8LEjWtc4rmNd','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::e9rkWZqb5dtoEUTB','logout','user.dashboard','user.edit','user.update',
...
'sections.files.store','sections.files.destroy','storage.local',);
...
'validation.attributes.value','validation.attributes.winner','validation.attributes.work','validation.attributes.year','fr.0',
...
'http-statuses.599','http-statuses.unknownError',);
