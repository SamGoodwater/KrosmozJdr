    ...
    <div>
        ...
        >
            ...
            <Tooltips placement="bottom-center">
                <template #reference>
                    <Route class="hover:scale-105 focus:scale-95" route="home">
                        ...
                        <h2 class="text-sm text-secondary/75 text-center">
                            {{ appSlogan }}
                        </h2>
                    </Route>
                </template>
            ...
            <div id="footer">
                ...
                <div class="btm-nav bg-transparent border-t-2 border-base-300 px-1">

                        <Tooltips placement="top" >
                            <template #reference>
                                <Route class="pb-1 text-minor-100 hover:text-main-300 relative cursor-pointer before:bg-main-300 before:absolute before:-bottom-0 before:-left-0  before:block before:h-[4px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100" route="contribute">
                                    <button>
                            ...
                            <template #label>
                                <span>Tout les liens pour<br><b>contribuer au projet KrosmozJDR</b></span>
                            </template>
                        </Tooltips>
                        <Tooltips placement="top" >
                            <template #reference>
