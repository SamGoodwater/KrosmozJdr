...
const isCriticalPage = computed(() => {
    const slug = String(pageModel.value?.slug || '').toLowerCase();
...
<template>
    ...
    >
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <div class="flex gap-2">
                    <span
                        ...
                        title="Page système critique protégée"
                    >
                        Page critique
                    </span>
                    <!-- Bouton copier l'URL -->
                    ...
                    <Btn
                        ...
                        @click="deletePage"
                        :title="isCriticalPage ? 'Suppression désactivée pour une page critique' : 'Supprimer la page'"
                    >
        ...
        <form v-if="activeTab === 'general' && formInstance" @submit.prevent="submit" class="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
            ...
            <Alert v-if="isCriticalPage" type="info">
                Cette page est critique. Le slug et la suppression sont verrouillés pour éviter les erreurs en production.
            </Alert>
            ...
            <div class="form-fields">
                ...
                <div class="form-field form-field--full">
                    <InputField
                        v-model="formInstance.menu_group"
