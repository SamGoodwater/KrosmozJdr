...
const shouldShowPasswordToggle = computed(() =>
    isPasswordType.value && (props.showPasswordToggle === undefined || props.showPasswordToggle === true)
);
...
const inputId = computed(() => props.id || `inputfield-${Math.random().toString(36).substr(2, 9)}`);
</script>
...
<template>
    <Tooltip :content="props.tooltip" :placement="props.tooltip_placement">
        <div class="form-control w-full">
            ...
            <InputLabel v-if="props.floating || $slots.leftLabel || $slots.rightLabel" :for="inputId" :value="label"
                :size="size" :color="color" :floating="props.floating">
                <template #default>
                    <div class="relative flex items-center w-full">
                        <!-- Left label (ex: préfixe, icône) -->
                        <span v-if="$slots.leftLabel" class="absolute left-3 z-10 flex items-center h-full">
                            <slot name="leftLabel" />
                        </span>
                        <!-- Input principal -->
                        ...
                        <span v-if="$slots.rightLabel" class="absolute right-3 z-10 flex items-center h-full">
                            <slot name="rightLabel" />
                        </span>
                        <!-- Password toggle -->
                        <button v-if="shouldShowPasswordToggle" type="button"
                        ...
                        <!-- Bouton reset -->
                        <Btn v-if="props.useFieldComposable && isFieldModified" class="absolute right-10 z-20" size="xs"
            ...
            <template v-else>
                <!-- Label top -->
                <InputLabel
                    v-if="labelTop || $slots.labelTop || (!labelTop && !label && !$slots.label && !$slots.labelTop)"
                    :for="inputId" :value="labelTop || label" :size="size" :color="color">
                ...
                <div class="relative flex items-center w-full">
                    <!-- Label left -->
                    <InputLabel v-if="labelLeft || $slots.labelLeft" :for="inputId" :value="labelLeft" :size="size"
                    ...
                    <!-- Label right -->
                    <InputLabel v-if="labelRight || $slots.labelRight" :for="inputId" :value="labelRight" :size="size"
                        :color="color" class="ml-2">
                ...
                <!-- Label bottom -->
                <InputLabel v-if="labelBottom || $slots.labelBottom" :for="inputId" :value="labelBottom" :size="size"
                    :color="color" class="mt-1">
