...
const ENTITY_TEXT_VAR = {
  section: 'var(--color-section-700)',
  page: 'var(--color-page-700)',
  npc: 'var(--color-npc-700)',
  item: 'var(--color-item-700)',
  creature: 'var(--color-creature-700)',
  shop: 'var(--color-shop-700)',
  campaign: 'var(--color-campaign-700)',
  resource: 'var(--color-resource-700)',
  monster: 'var(--color-monster-700)',
  specialization: 'var(--color-specialization-700)',
  spell: 'var(--color-spell-700)',
  user: 'var(--color-user-700)',
  attribute: 'var(--color-attribute-700)',
  capitalize: 'var(--color-capitalize-700)',
  breed: 'var(--color-breed-700)',
  consumable: 'var(--color-consumable-700)',
  scenario: 'var(--color-scenario-700)',
  condition: 'var(--color-condition-700)',
};
