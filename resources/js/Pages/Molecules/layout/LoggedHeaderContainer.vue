            ...
            <Dropdown position="bottom-end">
                ...
                <template #list>
                    <div id="notifications-panel"
                        class="flex flex-col items-center justify-center min-h-32 max-h-96 overflow-y-auto text-content-dark light:bg-base-100/80 dark:bg-base-900/80 p-2">
                        <p>Vous avez 0 notifications</p>
                    </div>
                </template>
            </Dropdown>
        ...
        <div class="flex flex-col text-center">
            <Dropdown position="bottom-end">
                <div class="flex items-center space-x-2">
                    <Avatar :source="avatar" :altText="pseudo" size="sm" rounded="full" theme="primary" />
