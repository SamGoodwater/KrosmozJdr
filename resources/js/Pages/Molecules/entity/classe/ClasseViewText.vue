<script setup>
/**
 * ClasseViewText — Vue Text pour Classe
 * 
 * @description
 * Nom de la classe + icône/image. Au survol, affiche ClasseViewMinimal.
...
import ClasseViewMinimal from './ClasseViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.classe.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
