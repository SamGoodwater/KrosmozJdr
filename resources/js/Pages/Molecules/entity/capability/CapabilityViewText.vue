<script setup>
/**
 * CapabilityViewText — Vue Text pour Capability
 * 
 * @description
 * Nom de la capacité + icône. Au survol, affiche CapabilityViewMinimal.
...
import CapabilityViewMinimal from './CapabilityViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.capability.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
