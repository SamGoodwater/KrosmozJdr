<script setup>
/**
 * ItemViewText — Vue Text pour Item
 * 
 * @description
 * Nom + icône/image. Au survol, affiche ItemViewMinimal.
...
import ItemViewMinimal from './ItemViewMinimal.vue';
...
<template>
    <div 
        ...
        <div class="flex-shrink-0" :class="item.image ? 'w-4 h-4' : ''">
            <Image 
                v-if="item.image" 
                :source="item.image" 
                :alt="item.name || 'Image'" 
