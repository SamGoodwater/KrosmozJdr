<script setup>
/**
 * CreatureViewText — Vue Text pour Creature
 * 
 * @description
 * Nom de la créature + icône. Au survol, affiche CreatureViewMinimal.
...
import CreatureViewMinimal from './CreatureViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.creature.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
