<script setup>
/**
 * AttributeViewText — Vue Text pour Attribute
 * 
 * @description
 * Nom de l'attribut + icône/image. Au survol, affiche AttributeViewMinimal.
...
import AttributeViewMinimal from './AttributeViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.attribute.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
