<script setup>
/**
 * ResourceTypeViewText — Vue Text pour ResourceType
 * 
 * @description
 * Nom + icône. Au survol, affiche ResourceTypeViewMinimal.
...
const nameCell = computed(() => {
    return props.resourceType.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
...
<template>
    <div 
        ...
        <!-- Icône à la même taille que le texte -->
        <div class="flex-shrink-0">
            <Icon 
                source="fa-solid fa-tag" 
