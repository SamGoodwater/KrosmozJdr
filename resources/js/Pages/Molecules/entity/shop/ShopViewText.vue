<script setup>
/**
 * ShopViewText — Vue Text pour Shop
 * 
 * @description
 * Nom de la boutique + icône. Au survol, affiche ShopViewMinimal.
...
import ShopViewMinimal from './ShopViewMinimal.vue';
