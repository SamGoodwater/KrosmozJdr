<script setup>
/**
 * ScenarioViewFull — Vue Full pour Scenario
 * 
 * @description
...
const canShowField = (fieldKey) => {
    ...
    if (typeof visibleIf === 'function') {
        try {
            ...
            console.warn('[ScenarioViewFull] visibleIf failed for', fieldKey, e);
            return false;
        }
    }
    return true;
...
<template>
    <div class="space-y-4">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-start">
            <!-- Image -->
            <div v-if="scenario.image" class="order-2 mx-auto w-fit shrink-0 md:order-1 md:mx-0">
                <Image
                    :src="scenario.image"
