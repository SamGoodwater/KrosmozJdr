<script setup>
/**
 * PanoplyViewText — Vue Text pour Panoply
 * 
 * @description
 * Nom de la panoplie + icône. Au survol, affiche PanoplyViewMinimal.
...
import PanoplyViewMinimal from './PanoplyViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.panoply.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
...
<template>
    <div 
        ...
        <div class="flex-shrink-0">
            <Icon 
                source="fa-solid fa-boxes" 
                :alt="panoply.name || 'Panoply'" 
                size="sm"
