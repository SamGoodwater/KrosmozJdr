<script setup>
/**
 * SpecializationViewCompact — Vue Compact pour Specialization
 * 
 * @description
 * Vue réduite d'une spécialisation avec informations essentielles.
...
const canShowField = (fieldKey) => {
    ...
    if (typeof visibleIf === 'function') {
        try {
            ...
            console.warn('[SpecializationViewCompact] visibleIf failed for', fieldKey, e);
            return false;
        }
    }
    return true;
