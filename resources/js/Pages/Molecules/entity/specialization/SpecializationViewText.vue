<script setup>
/**
 * SpecializationViewText — Vue Text pour Specialization
 * 
 * @description
 * Nom de la spécialisation + icône. Au survol, affiche SpecializationViewMinimal.
...
import SpecializationViewMinimal from './SpecializationViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.specialization.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
...
<template>
    <div 
        ...
        <div class="flex-shrink-0">
            ...
            <Icon
                v-else
                source="fa-solid fa-graduation-cap" 
                :alt="specialization.name || 'Specialization'" 
                size="sm"
