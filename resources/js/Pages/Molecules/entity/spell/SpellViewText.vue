<script setup>
/**
 * SpellViewText — Vue Text pour Spell
 * 
 * @description
 * Nom + icône/image. Au survol, affiche SpellViewMinimal.
...
import SpellViewMinimal from './SpellViewMinimal.vue';
...
const nameCell = computed(() => {
    return props.spell.toCell('name', {
        size: 'sm',
        context: 'text',
    });
});
...
<template>
    <div 
        ...
        <div class="flex-shrink-0" :class="spell.image ? 'w-4 h-4' : ''">
            <Image 
                v-if="spell.image" 
                :source="spell.image" 
