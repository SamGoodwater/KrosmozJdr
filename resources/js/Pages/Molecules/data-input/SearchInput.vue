...
<template>
    <div class="w-full flex items-center gap-2">
        <InputField :id="searchBarId" :placeholder="placeholder"
            @update:modelValue="(value) => emit('update:modelValue', value)" class="w-full">
            <template #icon>
                <Icon source="fa-solid fa-magnifying-glass" alt="Rechercher" size="sm" class="opacity-70" />
            </template>
        </InputField>
