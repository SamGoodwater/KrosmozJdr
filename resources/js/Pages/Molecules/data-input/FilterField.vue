 ...
 * 
 * @description
 * Molecule pour filtres de recherche complet, utilisant le système unifié useInputField.
 * 
 * @example
 * // Label simple
 * <FilterField label="Rechercher" v-model="search" placeholder="Tapez pour rechercher..." />
 * 
 * // Avec validation
 * <FilterField 
 *   label="Filtre" 
 *   v-model="filter"
 *   :validation="{ state: 'error', message: 'Le filtre est requis' }"
 * />
 * 
 ...
 *   label="Catégorie" 
 *   v-model="category"
 *   :options="['Tous', 'Tech', 'Design', 'Marketing']"
 *   helper="Filtrez par catégorie"
 * />
 */
