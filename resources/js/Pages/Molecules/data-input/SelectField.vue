 ...
 *
 * @description
 * Molecule pour champ select complet, orchestrant SelectCore (atom), InputLabel, validation, actions contextuelles, etc.
 ...
 *
 * @example
 * <SelectField label="Statut" v-model="status" :options="statusOptions" :actions="['reset', 'clear', 'copy']" />
 * <SelectField :label="{ top: 'Statut', inEnd: '.com' }" v-model="status" :options="statusOptions" />
 *
 ...
 * @props {Boolean} multiple, disabled, readonly, required, etc.
