<script setup>
/**
 * SpellType Index Page
 *
 * @description
 * Gestion/validation des types de sorts via `state`.
 */
...
onMounted(() => setPageTitle("Types de sorts"));
</script>

<template>
    <Head title="Types de sorts" />
