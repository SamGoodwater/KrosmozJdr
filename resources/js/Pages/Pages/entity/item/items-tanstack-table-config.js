...
export function createItemsTanStackTableConfig({ selectionEnabled = true } = {}) {
    return {
        ...
        columns: [
            ...
            { id: "level", label: "Niveau", sort: { enabled: true }, filter: { id: "level", type: "multi" }, cell: { type: "text" } },
            { id: "rarity", label: "Rareté", sort: { enabled: true }, filter: { id: "rarity", type: "multi" }, cell: { type: "badge" } },
            { id: "item_type", label: "Type", sort: { enabled: true }, filter: { id: "item_type_id", type: "multi" }, cell: { type: "text" } },
