/**
 * Scenarios TanStackTable config (Table v2)
 *
 * @description
...
export function createScenariosTanStackTableConfig() {
    return {
        id: "scenarios.index",
        ui: { skeletonRows: 10 },
        features: {
            search: { enabled: true, placeholder: "Rechercher un scénario…", debounceMs: 200 },
            ...
            export: { csv: true, filename: "scenarios.csv" },
        },
        columns: [
...
export default createScenariosTanStackTableConfig;
