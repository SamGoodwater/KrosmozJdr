/**
 * Panoplies TanStackTable config (Table v2)
 *
 * @description
...
export function createPanopliesTanStackTableConfig() {
    return {
        id: "panoplies.index",
        ui: { skeletonRows: 10 },
        features: {
            search: { enabled: true, placeholder: "Rechercher une panoplie…", debounceMs: 200 },
            ...
            export: { csv: true, filename: "panoplies.csv" },
        },
        columns: [
            ...
            { id: "bonus", label: "Bonus", hideable: true, sort: { enabled: true }, search: { enabled: true }, cell: { type: "text" } },
...
export default createPanopliesTanStackTableConfig;
