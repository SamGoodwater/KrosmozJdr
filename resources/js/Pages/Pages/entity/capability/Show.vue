...
import CapabilityViewLarge from "@/Pages/Molecules/entity/capability/CapabilityViewLarge.vue";
...
<template>
    ...
    <Container class="space-y-6 pb-8">
        <EntityViewLargeWrapper :show-back-button="true" back-route="entities.capabilities.index">
            <div class="space-y-6">
