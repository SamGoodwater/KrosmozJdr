 ...
 * 
 * @description
 * Page de modification d'une section dynamique.
 * - Formulaire complet pour modifier une section existante
 * - Support de différents types de sections
 * - Validation des champs
 * - Gestion des erreurs
 * 
 * @props {Object} section - Données de la section à modifier
...
setPageTitle(`Modifier la section`);
...
const form = useForm({
    ...
    type: props.section.type || 'text',
    params: props.section.params || {},
    is_visible: props.section.is_visible || 'guest',
    state: props.section.state || 'draft'
});

// Réinitialiser les params quand le type change (seulement si les params sont vides)
...
<template>
    ...
    <Container class="max-w-4xl mx-auto p-4 md:p-8">
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h1 class="card-title text-3xl mb-6">Modifier la section</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="card-actions justify-end mt-8">
                        <Btn
                            type="button"
                            variant="ghost"
                            @click="$inertia.visit(route('sections.show', section.id))"
                        >
                            Annuler
                        </Btn>
                        <Btn
