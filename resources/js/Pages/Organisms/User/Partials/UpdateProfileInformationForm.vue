...
<template>
    <section class="space-y-6 transition-all duration-200">
        ...
        <form @submit.prevent="updateProfile" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null" class="p-4 rounded-lg bg-warning-900/20 backdrop-blur-sm">
                ...
                <div
                    ...
                    class="mt-2 text-sm font-medium text-success-500"
                >
