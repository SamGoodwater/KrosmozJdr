/**
 * Attribute field descriptors — Version simplifiée
 *
 * @description
 ...
 * const descriptors = getAttributeFieldDescriptors({ meta });
 */

/**
 * @typedef {Object} AttributeFieldDescriptor
 ...
 */
export const ATTRIBUTE_QUICK_EDIT_FIELDS = Object.freeze([
  "usable",
  "is_visible",
  "description",
  "image",
...
/**
 * Retourne les descripteurs de tous les champs de l'entité "Attribute".
 * 
 * @param {Object} ctx - Contexte d'exécution
 * @param {Object} [ctx.capabilities] - Permissions disponibles (ou ctx.meta.capabilities)
 * @returns {Record<string, AttributeFieldDescriptor>} Objet avec tous les descripteurs
 */
export function getAttributeFieldDescriptors(ctx = {}) {
  ...
  return {
    ...
    _quickeditConfig: {
      fields: ATTRIBUTE_QUICK_EDIT_FIELDS,
    },

    // Support de la constante pour BulkConfig.fromDescriptors()
    _quickEditFields: ATTRIBUTE_QUICK_EDIT_FIELDS,
  };
}
