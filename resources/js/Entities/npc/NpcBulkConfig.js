/**
 * NpcBulkConfig — Configuration de l'édition en masse (bulk) pour NPC
 *
 * @description
 * Configuration de l'édition en masse pour les NPCs.
 * Doit rester aligné avec le backend (bulk controller).
 * Utilise les descriptors simplifiés et NPC_QUICK_EDIT_FIELDS.
 */

import { BulkConfig } from "../entity/BulkConfig.js";
import { getNpcFieldDescriptors, NPC_QUICK_EDIT_FIELDS } from "./npc-descriptors.js";

/**
 * Crée la configuration bulk pour NPC
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {BulkConfig} Configuration bulk
 */
export function createNpcBulkConfig(ctx = {}) {
  ...
  bulkConfig.withQuickEditFields(NPC_QUICK_EDIT_FIELDS);
