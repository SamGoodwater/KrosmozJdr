/**
 * SpellBulkConfig — Configuration de l'édition en masse (bulk) pour Spell
 *
 * @description
 * Configuration de l'édition en masse pour les sorts.
 * Doit rester aligné avec le backend (bulk controller).
 * Utilise les descriptors simplifiés et SPELL_QUICK_EDIT_FIELDS.
 */

import { BulkConfig } from "../entity/BulkConfig.js";
import { getSpellFieldDescriptors, SPELL_QUICK_EDIT_FIELDS } from "./spell-descriptors.js";

/**
 * Crée la configuration bulk pour Spell
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {BulkConfig} Configuration bulk
 */
export function createSpellBulkConfig(ctx = {}) {
  ...
  bulkConfig.withQuickEditFields(SPELL_QUICK_EDIT_FIELDS);
