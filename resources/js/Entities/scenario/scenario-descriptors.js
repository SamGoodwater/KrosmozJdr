/**
 * Scenario field descriptors — Version simplifiée
 *
 * @description
...
/**
 * Retourne les descripteurs de tous les champs de l'entité "Scenario".
 * 
 * @param {Object} ctx - Contexte d'exécution
 * @param {Object} [ctx.capabilities] - Permissions disponibles (ou ctx.meta.capabilities)
 * @returns {Record<string, ScenarioFieldDescriptor>} Objet avec tous les descripteurs
 */
export function getScenarioFieldDescriptors(ctx = {}) {
  ...
  return {
    ...
    progress_state: {
      ...
      table: {
        sortable: true,
        filterable: { id: "progress_state", type: "multi", defaultVisible: true },
