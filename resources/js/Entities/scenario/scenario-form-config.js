/**
 * Configuration partagée du formulaire scénario (édition).
 *
 * @module Entities/scenario/scenario-form-config
 */
 ...
 */
export function buildScenarioFormFieldsConfig(options = {}) {
...
export const SCENARIO_FORM_FIELD_SECTIONS_EDIT = [
    {
        id: 'general',
        title: 'Identité',
