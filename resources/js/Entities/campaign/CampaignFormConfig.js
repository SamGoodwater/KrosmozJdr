/**
 * CampaignFormConfig — Configuration des formulaires pour l'entité Campaign
 *
 * @description
 * Configuration des formulaires d'édition (simple et bulk) pour les campagnes.
...
/**
 * Crée la configuration des formulaires pour Campaign
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {FormConfig} Configuration des formulaires
 */
export function createCampaignFormConfig(ctx = {}) {
