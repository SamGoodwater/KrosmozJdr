/**
 * ShopBulkConfig — Configuration de l'édition en masse (bulk) pour Shop
 *
 * @description
 * Configuration de l'édition en masse pour les boutiques.
 * Doit rester aligné avec le backend (bulk controller).
 * Utilise les descriptors simplifiés et SHOP_QUICK_EDIT_FIELDS.
 */

import { BulkConfig } from "../entity/BulkConfig.js";
import { getShopFieldDescriptors, SHOP_QUICK_EDIT_FIELDS } from "./shop-descriptors.js";

/**
 * Crée la configuration bulk pour Shop
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {BulkConfig} Configuration bulk
 */
export function createShopBulkConfig(ctx = {}) {
  ...
  bulkConfig.withQuickEditFields(SHOP_QUICK_EDIT_FIELDS);
