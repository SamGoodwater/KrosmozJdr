/**
 * CapabilityBulkConfig — Configuration de l'édition en masse (bulk) pour Capability
 *
 * @description
 * Configuration de l'édition en masse pour les capacités.
 * Doit rester aligné avec le backend (bulk controller).
 * Utilise les descriptors simplifiés et CAPABILITY_QUICK_EDIT_FIELDS.
 */

import { BulkConfig } from "../entity/BulkConfig.js";
import { getCapabilityFieldDescriptors, CAPABILITY_QUICK_EDIT_FIELDS } from "./capability-descriptors.js";

/**
 * Crée la configuration bulk pour Capability
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {BulkConfig} Configuration bulk
 */
export function createCapabilityBulkConfig(ctx = {}) {
  ...
  bulkConfig.withQuickEditFields(CAPABILITY_QUICK_EDIT_FIELDS);
