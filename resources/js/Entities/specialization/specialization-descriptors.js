/**
 * Specialization field descriptors (Option B)
 *
 * @description
...
export const DEFAULT_SPECIALIZATION_FIELD_VIEWS = Object.freeze({
  table: { size: "small" },
  text: { size: "normal" },
  compact: { size: "small" },
  minimal: { size: "small" },
...
/**
 * Ordre d'affichage "Specialization" par vue.
 */
export const SPECIALIZATION_VIEW_FIELDS = Object.freeze({
  quickEdit: [
    "usable",
    "is_visible",
    "description",
...
export function getSpecializationFieldDescriptors(ctx = {}) {
  ...
  return {
    id: {
      ...
      display: {
        views: DEFAULT_SPECIALIZATION_FIELD_VIEWS,
    ...
    name: {
      ...
      format: "text",
      display: {
        views: { ...DEFAULT_SPECIALIZATION_FIELD_VIEWS, table: { size: "small", mode: "route" } },
