/**
 * ClasseBulkConfig — Configuration de l'édition en masse (bulk) pour Classe
 *
 * @description
 * Configuration de l'édition en masse pour les classes.
 * Doit rester aligné avec le backend (bulk controller).
 * Utilise les descriptors simplifiés et CLASSE_QUICK_EDIT_FIELDS.
 */

import { BulkConfig } from "../entity/BulkConfig.js";
import { getClasseFieldDescriptors, CLASSE_QUICK_EDIT_FIELDS } from "./classe-descriptors.js";

/**
 * Crée la configuration bulk pour Classe
 *
 * @param {Object} [ctx] - Contexte (permissions, etc.)
 * @returns {BulkConfig} Configuration bulk
 */
export function createClasseBulkConfig(ctx = {}) {
  ...
  bulkConfig.withQuickEditFields(CLASSE_QUICK_EDIT_FIELDS);
