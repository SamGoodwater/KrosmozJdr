...
export class Scenario extends BaseModel {
    ...
    /**
     * Génère une cellule pour un champ (surcharge pour gérer les champs spécifiques à Scenario)
    ...
    toCell(fieldKey, options = {}) {
        ...
        // Sinon, gérer les champs spécifiques à Scenario
