/**
 * Modèle CreatureTrait pour le frontend
 * 
 * @description
 * Classe pour normaliser et manipuler les données de creatureTrait côté frontend.
 * 
 * @example
 * const creatureTrait = new CreatureTrait(props.creatureTrait);
...
export class CreatureTrait extends BaseModel {
    ...
    /**
     * Génère une cellule pour un champ (surcharge pour gérer les champs spécifiques à CreatureTrait)
    ...
    toCell(fieldKey, options = {}) {
        ...
        // Sinon, gérer les champs spécifiques à CreatureTrait
