...
export class Attribute extends BaseModel {
    ...
    /**
     * Génère une cellule pour un champ (surcharge pour gérer les champs spécifiques à Attribute)
    ...
    toCell(fieldKey, options = {}) {
        ...
        // Sinon, gérer les champs spécifiques à Attribute
    ...
    _toNameCell(format, size, options) {
        ...
        const href = options.href || `/attributes/${this.id}`;
