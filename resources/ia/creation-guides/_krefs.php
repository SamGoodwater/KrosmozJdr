...
/**
 * Shortcodes kref partagés par les guides de création (CMS + prompt IA).
 *
...
return [
    ...
    'kEtats' => '[[kref:page:creation-etats|États]]',
    'kSortsPage' => '[[kref:page:creation-sorts|Sorts]]',
    'kEquipPage' => '[[kref:page:creation-equipements|Équipements]]',
    'kMonstresPage' => '[[kref:page:creation-monstres|Monstres]]',
    'kCapaPage' => '[[kref:page:creation-capacites|Capacités]]',
    ...
    'po' => '[[kref:characteristic:range_creature|PO]]',
    'force' => '[[kref:characteristic:strength_creature|Force]]',
    'intel' => '[[kref:characteristic:intelligence_creature|Intelligence]]',
    'sagesse' => '[[kref:characteristic:wisdom_creature|Sagesse]]',
    'agi' => '[[kref:characteristic:agility_creature|Agilité]]',
    'chance' => '[[kref:characteristic:chance_creature|Chance]]',
    'vitalite' => '[[kref:characteristic:vitality_creature|Vitalité]]',
    'wakfu' => '[[kref:characteristic:wakfu_reserve_creature|réserve de Wakfu]]',
];
