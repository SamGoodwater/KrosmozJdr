...
class CampaignBulkController extends Controller
{
    public function bulkUpdate(Request $request): JsonResponse
    {
        ...
        DB::beginTransaction();
        try {
            $models = Campaign::query()->whereIn('id', $ids)->get();
