...
/**
 * Charge les configs JSON V2 (source + entités) depuis resources/scrapping/v2/.
 *
...
final class ConfigLoader
{
    public function __construct(
        ...
        if (!is_dir($this->baseDir)) {
            throw new \InvalidArgumentException("Répertoire config V2 introuvable: {$this->baseDir}");
        }
    }
