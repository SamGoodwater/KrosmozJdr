...
class FusionMapsCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Assemble une mosaïque d\'images (public/images/1..N.jpg) en une fullmap (storage/app/public/maps/fullmap.jpg)';
    ...
    public function handle()
    {
        ...
        $destDir = storage_path('app/public/maps');
        if (! is_dir($destDir)) {
            mkdir($destDir, 0775, true);
        }
        $final_image->save($destDir.'/fullmap.jpg');
