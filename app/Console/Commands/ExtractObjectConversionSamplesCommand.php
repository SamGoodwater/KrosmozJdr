...
class ExtractObjectConversionSamplesCommand extends Command
{
    ...
    private const CHARACTERISTIC_KEY_LABELS = [
        'level_object' => 'Niveau',
        'life_points_max_object' => 'Points de vie',
        'action_points_object' => 'PA',
        'movement_points_object' => 'PM',
        'strength_object' => 'Force',
        'vitality_object' => 'Vitalité',
        'wisdom_object' => 'Sagesse',
        'chance_object' => 'Chance',
        'agility_object' => 'Agilité',
        'intelligence_object' => 'Intelligence',
        'summoning_object' => 'Invocation',
        'dodge_action_points_object' => 'Esquive PA',
        'dodge_movement_points_object' => 'Esquive PM',
        'resistance_50_percent_object' => 'Résistance %',
        'weight_object' => 'Pods',
        'initiative_object' => 'Initiative',
        'fixed_resistance_earth_object' => 'Terre (fixe)',
        'fixed_resistance_fire_object' => 'Feu (fixe)',
        'fixed_resistance_water_object' => 'Eau (fixe)',
        'fixed_resistance_air_object' => 'Air (fixe)',
    ];
